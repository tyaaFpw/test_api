    ...
    <div class="container">
      <div class="nav-inner">
        ...
        <ul id="nav" class="hidden-xs">
          ...
          <li class="level0 parent drop-menu"><a href="#"><span>Lorem</span> </a>
            <ul class="level1">
              <li class="level1 first"><a href="grid.html"><span>Grid</span></a></li>
              <li class="level1 nav-10-2"> <a href="list.html"> <span>List</span> </a> </li>
              <li class="level1 nav-10-3"> <a href="product_detail.html"> <span>Product Detail</span> </a> </li>
          ...
          <li class="level0 nav-6 level-top parent"> <a href="grid.html" class="level-top"> <span>Lorem</span> </a>
            <div class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
                ...
                <div class="nav-block nav-block-right std grid12-4">
                  <div class="static-img-block"><a href="#"><img src="{{ asset('frontend/images/nav-img1.jpg') }}" alt="Responsive"></a></div>
                </div>
              </div>
            </div>
          </li>
          <li class="level0 nav-5 level-top first"> <a class="level-top" href="grid.html"> <span>Lorem</span> </a>
            <div class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
              ...
              <div class="nav-add">
                <div class="push_item">
                  <div class="push_img"><a href="#"><img src="{{ asset('frontend/images/menu-sunglass.png') }}" alt="sunglass"></a></div>
                </div>
                <div class="push_item">
                  <div class="push_img"><a href="#"><img src="{{ asset('frontend/images/menu-sunglass.png') }}" alt="watch"></a></div>
                </div>
                <div class="push_item">
                  <div class="push_img"><a href="#"><img src="{{ asset('frontend/images/menu-sunglass.png') }}" alt="jeans"></a></div>
                </div>
                <div class="push_item">
                  <div class="push_img"><a href="#"><img src="{{ asset('frontend/images/menu-sunglass.png') }}" alt="shoes"></a></div>
                </div>
                <div class="push_item push_item_last">
                  <div class="push_img"><a href="#"><img src="{{ asset('frontend/images/menu-sunglass.png') }}" alt="swimwear"></a></div>
                </div>
              </div>
            </div>
          </li>
          <li class="level0"> <a class="level-top" href="grid.html"><span>lorem</span></a>
            <div class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
                <div class="nav-block nav-block-center"> 
          ...
          <li class="level0 parent drop-menu"><a href="grid.html"><span>Lorem </span> 
          ...
          <li class="nav-custom-link level0 level-top parent"> <a class="level-top" href="#"><span>Lorem</span></a>
            <div class="level0-wrapper custom-menu">
              <div class="header-nav-dropdown-wrapper clearer">
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="{{ asset('frontend/images/custom-img1.jpg') }}" alt="custom img1"></a></div>
                ...
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="{{ asset('frontend/images/custom-img2.jpg') }}" alt="custom img2"></a></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                  <button type="button" title="Add to Cart" class="learn_more_btn"><span>Learn More</span></button>
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="{{ asset('frontend/images/custom-img3.jpg') }}" alt="custom img3"></a></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                  <button type="button" title="Add to Cart" class="learn_more_btn"><span>Learn More</span></button>
                </div>
                <div class="grid12-5">
                  <div class="custom_img"><a href="#"><img src="{{ asset('frontend/images/custom-img4.jpg') }}" alt="custom img4"></a></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
                  <button type="button" title="Add to Cart" class="learn_more_btn"><span>Learn More</span></button>
                </div>
              </div>
